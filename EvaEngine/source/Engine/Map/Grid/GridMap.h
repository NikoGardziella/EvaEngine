...
namespace Engine {
	...
	public:
		...
		void EmitEdgeSubcellsOnSide(const glm::ivec2& cell, eTileDirection side, uint32_t slot, uint64_t uid, float cellW, float cellH, int subs, float shrinkAlong, float halfThickW, uint32_t health, uint32_t floor);
